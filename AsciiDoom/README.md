...
메뉴 선택은 현재 키보드로 처리합니다. 마우스 왼쪽 클릭 발사는 아직 지원하지 않습니다.

## 목표 화면과 남은 작업

<details>
<summary>최종 목표 목업 보기</summary>

![ASCII Doom 목표 목업: 실제 실행 결과가 아닌 개발 방향](https://github.com/user-attachments/assets/6aa996cd-3888-4ba7-840a-eed2e2bc6dde)

이 이미지는 개발 방향을 정하기 위해 선택한 생성 목업입니다. 실제 엔진 실행 결과는 문서 상단의 최신 UI 화면입니다.

</details>

- 총 1종의 발사 간격·탄약 소비·명중 판정 연결
- 몬스터 1종의 생성·추적·충돌·공격·피격·사망 구현
- HP·탄약과 승리·패배·재시작을 연결해 한 판의 흐름 완성
- 작은 평면 맵의 외형과 총·적·HUD 구도를 목표 화면에 맞춰 개선
